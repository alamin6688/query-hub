...
const MyProfile = () => {
  ...
  return (
    <>
      ...
      <div class="flex min-h-[calc(100vh-188px)] pt-16 relative items-center justify-center w-full animate__animated animate__zoomIn">
        <div class="rounded-xl overflow-hidden relative text-center p-4 group items-center flex flex-col max-w-sm hover:shadow-2xl transition-all duration-500 shadow-2xl w-full bg-base-100">
          ...
          <div class="group-hover:pb-10 transition-all duration-500 delay-200">
            <h1 class="font-semibold text-gray-700">{user?.displayName}</h1>
