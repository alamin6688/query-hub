    ...
    >
      <div className="flex items-center justify-center w-full h-full bg-gray-900/70">
        <div className="flex items-center flex-col justify-center">
          <h1 className="text-xl md:text-3xl w-[80%] mx-auto font-semibold text-white lg:text-4xl text-center font-poppins">
            {text}
          </h1>
          <br />
          <Link to="/queries">
            <button className="relative font-poppins inline-flex h-12 transition-transform duration-300 transform overflow-hidden rounded-lg p-[1px] focus:outline-none bg-slate-950 text-white hover:scale-105 hover:bg-slate-800">
