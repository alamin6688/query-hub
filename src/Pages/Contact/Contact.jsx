...
const Contact = () => {
  return (
    <>
      ...
      <section className="bg-white min-h-[calc(100vh-538px)] max-w-screen-2xl mx-auto ">
        <div className="px-6 py-6 mt-8 mb-16 bg-gray-100">
          <div className="animate__animated animate__slideInDown">
            ...
            <p className="w-full md:w-2/3 mx-auto mt-4 text-center text-gray-900 font-poppins text-[18px]">
              Our friendly team would love to hear from you. We are always here
